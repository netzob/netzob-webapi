...
from app.core.utils import Serializer
...
class ProjectHandler(object):
    ...
    def __load_project(self):
        self._logger.error("Loading project '{}'".format(self.project_id))

        self.__project = Project("Project {}".format(self.project_id))

    def __save_project(self):
        self._logger.error("Saving project '{}'".format(self.project_id))
